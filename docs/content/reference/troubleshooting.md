...
Most of these come down to network reality or how coinlore serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

coinlore rate-limits like any public site. coinlore already paces
...
Where a surface is gated, coinlore reads a cookie or token you supply
...
`coinlore`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what coinlore actually did
